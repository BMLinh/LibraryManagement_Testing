...
public class BookTestSuite {
    ...
    public void deleteSuccessful() throws SQLException {
        int id = 8;
        Assertions.assertTrue(bookService.delete(id));
    }

    @Test
    public void deleteFailed() throws SQLException {
        int id = 11111;
        Assertions.assertFalse(bookService.delete(id));
    }
    ...
    public void addSuccessful() throws SQLException {
        ...
        Assertions.assertTrue(bookService.add(book));
    ...
    public void updateSuccessful() throws SQLException {
        ...
        Assertions.assertTrue(bookService.update(id, pre));
    }
